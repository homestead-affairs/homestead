<!--
  LANDED FROM THE SAFE PLAYGROUND 2026-08-20.
  Origin: safe-app-store-public/apps/law-gazelle/docs/household_safety.md
  FACE-level (Homestead - Affairs), not app-level.
  Written 2026-08-04/05, before the re-platform onto homestead.keep.
  Read it as design intent and research, not as a description of current code.
-->
